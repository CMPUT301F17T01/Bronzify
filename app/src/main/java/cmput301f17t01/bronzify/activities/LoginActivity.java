...
public class LoginActivity extends Activity {
    ...
    emailText = LoginActivity(R.id.field_email);
    passwordText = LoginActivity(R.id.field_password);
    ...
    @Override
    public void onStart() {
        // TODO: Transition out of the landing page once user has logged in.
        super.onStart();
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(LoginActivity.this,"Could not create user", Toast.LENGTH_SHORT).show();
                            refreshScreen(null);
                        }
                    }
                }
